...
export class Secondary {
  public static Message = styled('span')`
    padding-left: 26px;
  ...
  public static Join = styled(Secondary.Message)`
  ...
  public static Pinned = styled(Secondary.Message)`
...
export class Sys {
  ...
  public static Lines = styled('div')`
    width: calc(100% - 50px);
    height: 16px;
    position: absolute;
    left: 50%;
