...
export const ThemeProvider = ({children}) => {
	...
	const singleChannel = data.guild && data.guild.settings && data.guild.settings.singleChannel;
	if (singleChannel && router.channel !== singleChannel) history.push(`/${router.guild}/${singleChannel}`)
	...
	const themeContext: ThemeContext = {
		...
		singleChannel: data.guild && data.guild.settings.singleChannel,
		colors: {
			...theme.colors,
