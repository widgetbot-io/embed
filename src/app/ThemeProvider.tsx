...
export const ThemeProvider = ({ children }) => {
  ...
  let theme: Theme_guild_theme = {
    ...
    colors: {
      ...
      primary: data.guild && data.guild.theme && data.guild.theme.colors.primary || Constants.THEME_COLOR_PRIMARY,
      accent: data.guild && data.guild.theme && data.guild.theme.colors.accent || Constants.THEME_COLOR_ACCENT,
      background: data.guild && data.guild.theme && data.guild.theme.colors.background || Constants.THEME_BACKGROUND
    },
    css: ``
  };
